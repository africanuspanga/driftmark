...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Top Logo */}
      <header className="fixed top-0 left-0 right-0 z-50 flex md:hidden items-center px-4 py-3">
        <a href="#">
          <Image
            src="/driftmark-logo.png"
            alt="Driftmark Technologies"
          ...
          <nav className="flex flex-col px-6 py-10 gap-1">
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={() => setMenuOpen(false)}
                className="text-3xl font-light text-foreground py-4 border-b border-border transition-colors hover:text-muted-foreground"
              >
                {link.label}
              </a>
            ))}
...
function SoftwareSection() {
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl font-light text-foreground mb-16 md:mb-24">
        Our Software
      </h2>
          ...
          >
            ...
            <div className="flex md:hidden flex-col gap-4">
              <div className="flex items-start justify-between">
                <h3 className="text-5xl font-light tracking-tight text-foreground leading-none">
                  {product.name}
                </h3>
            ...
            <div className="hidden md:flex items-start gap-8">
              ...
              <div className="flex-1 flex items-center justify-end">
                <h3 className="text-8xl lg:text-9xl xl:text-[10rem] font-light tracking-tight text-foreground leading-none transition-opacity group-hover:opacity-70">
                  {product.name}
                </h3>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 md:mb-28">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-background/30 px-8 py-4 text-sm font-medium text-background transition-colors hover:bg-background hover:text-foreground"
          >
            Contact Us
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-background/10 pt-12">
          <div>
            <Image
              src="/driftmark-logo.png"
              alt="Driftmark Technologies"
            ...
            <p className="text-sm text-background/60 leading-relaxed max-w-xs">
              Building AI-powered automation for enterprises and governments
          ...
          <div className="flex flex-col gap-3">
            ...
            {["Nivora", "Mkwawa", "Dukalink", "Atlas", "Twiga"].map((name) => (
              <a
                key={name}
                href="#software"
                className="text-sm text-background/80 hover:text-background transition-colors"
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-t border-background/10 pt-8 mt-12">
          ...
          <p className="text-xs text-background/40">Dar es Salaam, Tanzania</p>
        </div>
      </div>
